...
class Brain:
    ...
    def predictOne(self, s, target=False):
        print (self.stateCnt)
        return self.predict(s.reshape(1, (2, self.mapSize[0]+2, self.mapSize[1]+2)), target).flatten()
...
class Memory:   # stored as ( s, a, r, s_ ) in SumTree
    ...
    def update(self, idx, error): # Update Priority of a sample
        ...
        #-------------------- AGENT ---------------------------
MEMORY_CAPACITY = 2000 # change to 200 000
...
try:
    ...
    while True:
        ...
        agent.brain.model.save_weights("model.h5")
