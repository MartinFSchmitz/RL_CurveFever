...
class Environment:
    ...
    def run(self, agent, pre):            
        ...
        self.game.init(render = False)
        s, r, done = pre.cnn_preprocess_state(self.game.get_game_state())
        R = 0
        ...
        while True:         
            ...
            r = 0
            s_, r, done = pre.cnn_preprocess_state(self.game.AI_learn_step())
